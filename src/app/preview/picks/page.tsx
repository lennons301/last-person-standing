		...
		<div className="space-y-10">
			<div className="space-y-2 text-sm text-muted-foreground">
				<p>
					...
					form-detail panel that hangs off it. Then turbo's whole picker: its ranked list, its
					remaining-fixtures list, and each state of its submission. Hand-built fixtures, no auth,
					no database.
				</p>
				<p>
